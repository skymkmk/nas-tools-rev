...
def MetaInfo(title,
    ...
    meta_info.ignored_words.extend(used_info.get("ignored"))
    meta_info.replaced_words.extend(used_info.get("replaced"))
    meta_info.offset_words.extend(used_info.get("offset"))
